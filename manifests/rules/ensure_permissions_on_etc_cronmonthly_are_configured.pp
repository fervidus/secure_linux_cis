...
#
# @example
#   include secure_linux_cis::ensure_permissions_on_etc_cronmonthly_are_configured
class secure_linux_cis::rules::ensure_permissions_on_etc_cronmonthly_are_configured {
