...
#
# @summary  Ensure permissions on /etc/cron.hourly are configured (Scored)
#
# @param enforced Should this rule be enforced
#
# @example
#   include secure_linux_cis::ensure_permissions_on_etc_cronhourly_are_configured
class secure_linux_cis::rules::ensure_permissions_on_etc_cronhourly_are_configured {
