...
#
# @summary  Ensure permissions on /etc/cron.daily are configured (Scored)
#
# @param enforced Should this rule be enforced
#
# @example
#   include secure_linux_cis::ensure_permissions_on_etc_crondaily_are_configured
class secure_linux_cis::rules::ensure_permissions_on_etc_crondaily_are_configured {
    file { '/etc/cron.daily':
      ensure => directory,
      group  => 'root',
      owner  => 'root',
