...
#
# @example
#   include secure_linux_cis::ensure_permissions_on_etc_cron_hourly_are_configured
class secure_linux_cis::ensure_permissions_on_etc_cron_hourly_are_configured (
