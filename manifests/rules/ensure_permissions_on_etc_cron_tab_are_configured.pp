...
#
# @example
#   include secure_linux_cis::ensure_permissions_on_etc_cron_tab_are_configured
class secure_linux_cis::rules::ensure_permissions_on_etc_cron_tab_are_configured {
  file { '/etc/crontab':
    ensure => directory,
    group  => 'root',
    owner  => 'root',
