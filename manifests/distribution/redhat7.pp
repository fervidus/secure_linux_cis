...
class secure_linux_cis::distribution::redhat7 (
  ...
  include ::secure_linux_cis::distribution::redhat7::cis_1_2_2  #TODO: find a good way to automate
  ...
  # class { '::secure_linux_cis::distribution::redhat7::cis_3_3_2':
  #   ipv6_enabled => $ipv6_enabled,
  # }
